...
[Architecture essay](https://corelay.dev/architecture) · [Agent-Factory thesis](https://corelay.dev/agent-factory) · [Docs](https://corelay-dev.github.io/mesh/) · [Website](https://corelay.dev) · [Examples](./examples)
